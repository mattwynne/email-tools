defmodule InboxCoach.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :fastmail_api_key, InboxCoach.Encrypted.Binary
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, InboxCoach.Repo)
  ...
  """
  def valid_password?(%InboxCoach.Accounts.User{hashed_password: hashed_password}, password)
