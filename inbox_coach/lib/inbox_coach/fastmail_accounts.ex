defmodule InboxCoach.FastmailAccounts do
  @moduledoc """
  ...
  alias InboxCoach.{Accounts, FastmailAccount}
  ...
  def get_account_pid(user_id) do
    case Registry.lookup(InboxCoach.FastmailAccountRegistry, user_id) do
      [{pid, _}] -> pid
      [] -> nil
    end
  end
  ...
  defp via_tuple(user_id) do
    {:via, Registry, {InboxCoach.FastmailAccountRegistry, user_id}}
  end
  ...
  defp list_users_with_api_keys do
    ...
    from(u in InboxCoach.Accounts.User,
