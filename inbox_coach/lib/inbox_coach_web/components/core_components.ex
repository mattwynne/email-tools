defmodule InboxCoachWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 dark:bg-zinc-800 dark:ring-zinc-600/50 relative hidden rounded-2xl bg-white p-14 shadow-lg ring-1 transition"
            >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-zinc-900 dark:bg-zinc-700 hover:bg-zinc-700 dark:hover:bg-zinc-600 py-2 px-3",
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 dark:border-zinc-600 text-zinc-900 dark:text-zinc-100 dark:bg-zinc-800 focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 shadow-sm focus:border-zinc-400 dark:focus:border-zinc-500 focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InboxCoachWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InboxCoachWeb.Gettext, "errors", msg, opts)
    end
  end
