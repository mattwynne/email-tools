...
#
#     PHX_SERVER=true bin/inbox_coach start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :inbox_coach, InboxCoachWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :inbox_coach, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :inbox_coach, InboxCoach.Mailer,
